...
export default function StepCamera() {
  ...
  // 컴포넌트 마운트 시 AI 추천 요청
  useEffect(() => {
    console.log("🎬 StepCamera useEffect:", { recommendation: !!recommendation, isLoading, error });
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
        <p className="text-sm text-blue-900 leading-relaxed">
          ...
          촬영조명팀 <strong>{state.basicInfo.crewSize}명</strong>에게 적합한 카메라를 추천합니다.
        </p>
      </div>
      ...
      {isLoading && (
        <div className="flex flex-col items-center justify-center py-12 space-y-3">
          ...
          <p className="text-sm text-gray-500">AI가 최적의 카메라를 분석중입니다...</p>
        </div>
      )}
